//
//  DetailStartupVC.swift
//  GoogleMapsCustomStyle
//
//  Created by Rohmat Suseno on 24/01/20.
...
class DetailStartupVC: UIViewController {
    ...
    var passedData = (title: "Name", img: #imageLiteral(resourceName: "signin_image"))
...
struct Detail_Preview: PreviewProvider {
    static var previews: some View {
        ContentView().previewDevice(.init(stringLiteral: "iPhone 6s"))
    }
    
    struct ContentView: UIViewControllerRepresentable {
        func makeUIViewController(context: UIViewControllerRepresentableContext<Detail_Preview.ContentView>) -> UIViewController {
            return DetailStartupVC()
        }
        
        func updateUIViewController(_ uiViewController: UIViewController, context: UIViewControllerRepresentableContext<Detail_Preview.ContentView>) {
